...
python train.py --stage fusion --name coco_mask --sample_p 1.0 --niter 5 --niter_decay 0 --lr 0.00001 --model train --load_model --display_ncols 4 --fineSize 256 --batch_size 8 --display_ncols 3 --display_freq 100 --print_freq 100 --train_img_dir train_data/train2017 --lambda_kl 0.00000000000000025
